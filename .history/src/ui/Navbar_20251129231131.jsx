    ...
    <nav className="bg-[var(--backGround-color)] px-6 py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="text-xl font-semibold flex items-center gap-1">
          <span><img src="/src/assets/navLogo/logo2.png" alt="logo"
            className="w-10 md:w-15 rounded-xl object-cover" /></span><span className="text-[var(--main-lite-color)] text-2xl">Medicare</span>
        </div>
