    ...
    <header className="bg-[var(--backGround-color)] pt-16 pb-24">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 px-6">
        ...
        <div className="flex flex-col justify-center">
          ...
          {/* TITLE */}
          <h1 className="text-4xl md:text-3xl font-extrabold text-[var(--main-color)] leading-tight">
            FEEL BETTER ABOUT<br />
            <span className="block mt-2">FINDING HEALTHCARE</span>
          </h1>

          {/* DESCRIPTION */}
          <p className="text-[var(--head-desc-color)] mt-6 ">
        ...
        <div className="flex justify-center items-center gap-4">
          <img 
            src="/src/assets/headerPhoto/drHeader.jpg" 
            alt="doctor" 
            className="w-500 md:w-64 rounded-xl object-cover"
          />
          {/* <img 
