    ...
    <nav className="bg-[var(--backGround-color)] px-6 py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="text-xl font-semibold flex items-center gap-1">
          <img src="/src/assets/navLogo/Blue_and_White_Simple_Medical_Health_Logo__1_-removebg-preview.png" alt="" /><span className="text-[var(--main-lite-color)] text-2xl">Medicare</span>
        </div>
