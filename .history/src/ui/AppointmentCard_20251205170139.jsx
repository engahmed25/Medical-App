    ...
    <div className="bg-[var(--sec-color)] rounded-lg shadow-md p-4 sm:p-6 w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[auto_1fr_auto] gap-4 sm:gap-12 items-center">
        ...
        <div className="flex flex-col gap-3 w-full md:w-auto">
          ...
          <Button 
            onClick={onCancel}
            className="bg-[var()]  hover:bg-gray-50  px-6 sm:px-8 py-2.5 rounded-md font-medium border border-gray-300 transition-colors text-sm sm:text-base w-full md:w-auto whitespace-nowrap"
          >
            Cancel appointment
          </Button>
        </div>
