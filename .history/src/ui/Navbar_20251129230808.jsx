    ...
    <nav className="bg-[var(--backGround-color)] px-6 py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="text-xl font-semibold flex items-center gap-1">
          <img src="/src/assets/navLogo/Blue_and_White_Simple_Medical_Health_Logo__2_-removebg-preview.png" alt="doctor"
            className="w-56 md:w-64 rounded-xl object-cover" /><span className="text-[var(--main-lite-color)] text-2xl">Medicare</span>
        </div>
        ...
        <div className="hidden md:flex items-center gap-4">
          <button className="text-[var(--main-color)] font-bold">
            Log in
          </button>
      ...
      {open && (
        <div className="md:hidden mt-4 space-y-4 bg-[var(--sec-color)] p-4 rounded-lg">
          ...
          <div className="flex flex-col gap-3 pt-3">
            <button className="text-[var(--main-color)] font-medium">Log in</button>
