...
export default function Notification() {
  const [notifications, setNotifications] = useState([
    ...
    { id: 2, message: 'Dr. Smith accepted your request', time: '1 hour ago', read: true },
    { id: 3, message: 'Prescription ready for pickup', time: '2 hours ago', read: true },
    { id: 4, message: 'New appointment scheduled', time: '5 min ago', read: false },
    { id: 5, message: 'Dr. Smith accepted your request', time: '1 hour ago', read: true },
    { id: 6, message: 'Prescription ready for pickup', time: '2 hours ago', read: true }
  ]);
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-80 sm:w-96 bg-white rounded-lg shadow-xl border border-gray-200 z-50 max-h-[32rem] flex flex-col">
          ...
          <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-gray-50 rounded-t-lg">
            <h3 className="font-semibold text-var(--head-desc-color) text-lg">Notifications</h3>
